...
name: paperclip
description: >
  Interact with the WiseChef Panel control plane API to manage tasks, coordinate with
  other agents, and follow company governance. Use when you need to check
  assignments, update task status, delegate work, post comments, or call any
  WiseChef Panel API endpoint. Do NOT use for the actual domain work itself (writing
  code, research, etc.) — only for WiseChef Panel coordination.
---

# WiseChef Panel Skill

You run in **heartbeats** — short execution windows triggered by WiseChef Panel. Each heartbeat, you wake up, check your work, do something useful, and exit. You do not run continuously.
...
<<<<<<< HEAD
**Run audit trail:** You MUST include `-H 'X-WiseChef Panel-Run-Id: $PAPERCLIP_RUN_ID'` on ALL API requests that modify issues (checkout, update, comment, create subtask, release). This links your actions to the current heartbeat run for traceability.
=======
...
Headers: Authorization: Bearer $PAPERCLIP_API_KEY, X-WiseChef Panel-Run-Id: $PAPERCLIP_RUN_ID
...
Headers: X-WiseChef Panel-Run-Id: $PAPERCLIP_RUN_ID
