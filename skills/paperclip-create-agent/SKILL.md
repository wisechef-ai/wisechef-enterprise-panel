...
description: >
  Create new agents in WiseChef Panel with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# WiseChef Panel Create Agent Skill
...
2. Discover available adapter configuration docs for this WiseChef Panel instance.
