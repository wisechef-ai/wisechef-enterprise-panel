...
WiseChef Panel supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying WiseChef Panel?** Use `local_trusted` (the default)
