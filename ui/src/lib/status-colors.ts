...
export const issueStatusIcon: Record<string, string> = {
  ...
  in_review: "text-orange-600 border-orange-600 dark:text-orange-400 dark:border-orange-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  in_review: "text-orange-600 dark:text-orange-400",
...
export const statusBadge: Record<string, string> = {
  ...
  in_review: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
